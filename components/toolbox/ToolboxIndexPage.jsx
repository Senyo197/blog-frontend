...
const ToolboxIndexPage = ({
  ...
  return (
    <>
      ...
      {pagination?.page == 1 && title == "All tools" ? (
      ...
      >
        ...
        />
        <div
          className={`w-full px-0 ${title == "All tools" && pagination?.page == 1 ? "" : "-mt-28 lg:-mt-20"} pl-0 md:pl-8 mx-auto pb-20 gap-2 col-span-12 md:col-span-10`}
        >
          {router.isFallback ? (
...
const Sidebar = ({
  ...
  return (
    ...
    <div
      className={`${title !== "All tools" ? "mt-6" : ""} hidden md:block h-[fit-content] relative col-span-2 rounded-3xl`}
    >
